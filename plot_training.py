...
plt.plot(epoch, train_loss, label='Training Loss', color='blue', marker='.', linestyle='None')
plt.plot(epoch, val_loss, label='Validation Loss', color='red', marker='*', linestyle='None')
plt.xlabel('Epoch')
plt.ylabel('Loss')
plt.legend()
...
plt.plot(epoch, val_mean_accuracy, label='Mean accuracy', color='green', marker='o', linestyle='None')
plt.plot(epoch, val_median_accuracy, label='Median accuracy', color='grey', marker='+', linestyle='None')
plt.xlabel('Epoch')
plt.ylabel('Accuracy')
plt.legend()
plt.xlim(0, len(epoch))
